  ...
  <div class="min-w-full min-h-screen bg-gray-100 flex">
    <div class="sidebar flex-grow-0 hidden md:block">
      <div class="w-full h-full flex flex-col items-center">
        ...
        <div class="p-1 mb-2 mt-6">
          <img src="@/assets/book-outline.svg" alt="" class="w-full" />
        </div>
        <div class="p-1.5 mx-3">
          <img src="@/assets/heart.svg" alt="" class="w-full" />
        </div>
      </div>
    </div>
          ...
          >
            ...
            <div>
              ...
              <ul class="mt-4 text-xs">
                <li class="mb-4">
                  <div>
                    <label class="block text-green-500 uppercase font-bold mb-1"
                      >Language</label
                    >
                    <select
                      name="lang"
              ...
              <h3
                class="text-sm font-bold flex justify-between items-center mb-4"
              >
                <div>
